...
const AnswerComponent = ({
  ...
  const isQuestionOwner = question.askedBy && question.askedBy.id === currentUserId;
        ...
        <div className="comment-text">
          ...
          <div className="author clearfix">
            {question.hasAcceptedAnswer && answer.isTheBest && (
              <div className="best-answer">{t('answer_best_answers')}</div>
            )}
            {isQuestionOwner && !question.hasAcceptedAnswer && !isAnswerOwner && (
              <button
            ...
            <div className="comment-meta">
              ...
              >
                <span itemProp="dateCreated">
                  Added an answer on {new Date(answer.createdOn).toDateString()}
                </span>
              </a>
            </div>
          </div>
          <div className="text">
            ...
            <Vote
              disableUp={isAnswerOwner || (lastVote && lastVote.action === 'up')}
              disableDown={isAnswerOwner || (lastVote && lastVote.action === 'down')}
