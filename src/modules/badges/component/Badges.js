        ...
        <span className="crumbs">
          <span>
            ...
            <span>
              ...
              <span className="current">{t('common_badges')}</span>
            </span>
          </span>
        </span>
              ...
              <ul className="row">
                ...
                <li className="col col4">
                  <div className="point-section" style={{ height: '109px' }}>
                    ...
                    <p>{t('badges_choosing_the_best')}</p>
                  </div>
                </li>
                <li className="col col4">
                  <div className="point-section" style={{ height: '109px' }}>
                ...
                <li className="col col4">
                  <div className="point-section" style={{ height: '109px' }}>
                    ...
                    <p>{t('badges_voting_a_question')}</p>
                  </div>
                </li>
                <li className="col col4">
                  <div className="point-section" style={{ height: '109px' }}>
              ...
              <ul>
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 50 {t('badges_in_at_least')}{' '}
                      10
                ...
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 100 {t('badges_in_at_least')}{' '}
                      50
                      {t('badges_non_community_wiki')} 50.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 150 {t('badges_in_at_least')}{' '}
                      100
                      {t('badges_non_community_wiki')} 100.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 200 {t('badges_in_at_least')}{' '}
                      150
                      {t('badges_non_community_wiki')} 150.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 250 {t('badges_in_at_least')}{' '}
                      200
                      {t('badges_non_community_wiki')} 200.
                    </p>
                  </div>
                </li>
                <li>
                  <div className="badge-section">
                    ...
                    <p>
                      {t('badges_you_must_have')} 250 {t('badges_in_at_least')}{' '}
                      250
                      {t('badges_non_community_wiki')} 250.
                    </p>
                  </div>
                </li>
              </ul>
